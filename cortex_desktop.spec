...
a = Analysis(
    ...
    hiddenimports=[
        ...
        # Training pipeline (direct import, no subprocess)
        "cortex_train",
        "cortex_train.config",
        "cortex_train.paths",
        "cortex_train.prompts",
        "cortex_train.formats",
        "cortex_train.lmstudio",
        "cortex_train.pi_client",
        "cortex_train.progress",
        "cortex_train.errors",
        "cortex_train.steps",
        "cortex_train.steps.sync",
        "cortex_train.steps.synthesize",
        "cortex_train.steps.prepare",
        "cortex_train.steps.train",
        "cortex_train.steps.evaluate",
        "cortex_train.steps.deploy",
        "cortex_train.steps.dream",
        "serial",
        "serial.tools",
